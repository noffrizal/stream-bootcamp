    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-primary">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form enctype="multipart/form-data" method="POST" action="{{ route('movie.update', $movie->id) }}">
                    @method('PUT')
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="movie" name="movie" value="{{ $movie->movie }}"
                                placeholder="Video url">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group date" id="release-date" data-target-input="nearest">
                                <input type="text" name="release_date" class="form-control datetimepicker-input" value="{{ $movie->release_date }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="short-about" name="casts" value="{{ $movie->casts }}"
                                placeholder="Jackie Chan">
                        </div>
                        <div class="form-group">
                            <label for="short-about">Categories</label>
                            <input type="text" class="form-control" id="short-about" name="categories" value="{{ $movie->categories }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="short-about" name="short_about" value="{{ $movie->short_about }}"
                                placeholder="Awesome Movie">
                        </div>
                        <div class="form-group">
                            <label for="short-about">About</label>
                            <input type="text" class="form-control" id="about" name="about" value="{{ $movie->about }}"
                                placeholder="Awesome Movie">
                        </div>
                        <div class="form-group">
